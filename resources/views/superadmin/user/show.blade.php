        ...
        <div class="card-body p-4 p-md-5">
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            ...
                            <div class="input-group input-group-focus rounded-3">
                                ...
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none text-muted" value="{{ $user->id }}" readonly style="cursor: not-allowed; opacity: 0.8;">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold text-navy mb-1 small">Email</label>
                            <div class="input-group input-group-focus rounded-3">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-envelope"></i></span>
                                <input type="email" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $user->email }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold text-navy mb-1 small">Status Akun</label>
                            @php
                            ...
                            <div class="input-group input-group-focus rounded-3">
                                ...
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none fw-bold text-{{ $statusClass }}" value="{{ $status }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-navy mb-1 small">Nama Depan</label>
                            <div class="input-group input-group-focus rounded-3">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-user"></i></span>
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $user->firstname }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-focus rounded-3">
                                ...
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $user->lastname ?? '-' }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-navy mb-1 small">NIP</label>
                            <div class="input-group input-group-focus rounded-3">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-id-badge"></i></span>
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $user->nip }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-navy mb-1 small">No. Telepon</label>
                            <div class="input-group input-group-focus rounded-3">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-phone-alt"></i></span>
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $user->phone_number }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-navy mb-1 small">Organisasi</label>
                            @php
                            ...
                            <div class="input-group input-group-focus rounded-3">
                                ...
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $orgName }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-navy mb-1 small">Posisi</label>
                            <div class="input-group input-group-focus rounded-3">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-briefcase"></i></span>
                                <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $user->position->nm_position ?? '-' }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-focus rounded-3">
                            ...
                            <input type="text" class="form-control bg-light border-start-0 ps-0 shadow-none" value="{{ $roleName }}" readonly style="{{ $roleColorStyle }}">
                        </div>
                    </div>
                    ...
                    <div class="w-100">
                        ...
                        @php
                            $kodeBagianArray = $user->kode_bagian
                                ...
                                : [];
                        @endphp
                        <div class="w-100 border rounded-3 overflow-hidden text-start" style="border-color: #ced4da;">
                            @if(count($kodeBagianArray) > 0)
                                {{-- Baris 1: Header Info --}}
                                <div class="px-3 py-2 bg-white border-bottom d-flex align-items-center gap-2">
                                ...
                                <div class="bg-white w-100" style="max-height: 250px; overflow-y: auto;">
                                    @foreach($kodeBagianArray as $index => $kode)
                                        @php $bagian = $bagianKerja->firstWhere('kode_bagian', $kode); @endphp
                                        
                                        {{-- Container per baris aset --}}
                                        <div class="d-flex align-items-center w-100 px-3 py-2" style="{{ $index > 0 ? 'border-top: 1px solid #dee2e6;' : '' }}">
                                            
                                            {{-- Kiri: Badge Kode --}}
                                            <div class="me-3 flex-shrink-0">
                                                <span class="badge bg-primary text-white rounded-1 text-center" style="min-width: 65px; padding: 8px 12px; font-size: 0.85rem; letter-spacing: 0.5px;">
                                                    {{ $kode }}
                                                </span>
                                            </div>
                                            
                                            {{-- Kanan: Teks --}}
                                            <div class="text-dark fw-medium text-wrap" style="font-size: 0.9rem;">
                            ...
                            @else
                                <div class="px-3 py-3 bg-white d-flex align-items-center gap-2 text-muted">
