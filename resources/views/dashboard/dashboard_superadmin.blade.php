...
<div class="container-fluid px-1 py-0 mt-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Selamat datang kembali, {{ auth()->user()->firstname }}. Berikut ringkasan aset hari ini.</p>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card glass-card p-4 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <select class="form-select form-select-sm w-auto bg-light border-0 shadow-sm rounded-pill" style="padding-left: 1rem; padding-right: 2.5rem; cursor: pointer;" onchange="window.location.href='{{ route('superadmin.dashboard') }}?year=' + this.value">
        ...
        <div class="col-lg-4">
            ...
            <div class="row g-2 mb-4">
                ...
                <div class="col-6">
                    <a href="{{ route('user.manage') }}" class="quick-access-btn shadow-sm">
                        <i class="fas fa-users"></i>
                        <span class="fw-bold small text-center">Kelola User</span>
                    </a>
                </div>
                <div class="col-6">
