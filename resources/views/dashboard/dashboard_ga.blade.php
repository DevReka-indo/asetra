            ...
            <div class="d-flex align-items-center w-100 position-relative" style="z-index: 1;">
                ...
                <div>
                    ...
                    <p class="mb-0 opacity-90 small" style="line-height: 1.5;">
                        ...
                        <span class="badge bg-white text-navy fw-bold px-2.5 py-1.5 ms-1 rounded-pill" style="color: #1A2355 !important; font-size: 0.75rem; letter-spacing: 0.5px;">{{ auth()->user()->role->nm_role }} (General Affairs)</span>
                    </p>
                </div>
            </div>
        </div>
